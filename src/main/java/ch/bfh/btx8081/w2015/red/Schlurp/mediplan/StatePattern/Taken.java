...
public class Taken extends DrugState {
	...
	/**
	 * Constructor of the taken state Needs a Medicament
	 * 
	 * @param aMedi
	 *            - Medicament
	 */
	...
	/**
	 * it changes from Taken to Upcoming and uses afterwards the checktime
	 * Method to check if the Medicament date is still expired. Also the Date
	 * gets returned to the last time, when the Medi has been taken
	 */
