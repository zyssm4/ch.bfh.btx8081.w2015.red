...
public class Upcoming extends DrugState {
	 ...
	 * Aswell the next ToTake Date gets updated and will be set to the actToTake
	 * Date + the intervall
	 */
	public void switchState() {
		int intervallTimeInHours = Integer.parseInt(actMedi.getInterval());
		actMedi.setToTake(new Date(actMedi.getToTake().getTime()
				+ intervallTimeInHours * 3600000));
