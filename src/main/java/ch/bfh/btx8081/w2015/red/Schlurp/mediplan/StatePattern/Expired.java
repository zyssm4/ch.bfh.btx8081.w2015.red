 ...
 * 
 * Aswell it has the switchState to change from Expired to Taken if the
...
public class Expired extends DrugState {
	...
	/**
	 * Constructor of the Expired state Needs a Medicament
	 * 
	 * @param aMedi
	 *            - Medicament
	 */
	...
	/**
	 * 
	 * Switches the State to taken from expired. Also the Date gets returned to
	 * the last time, when the Medi has been taken
	 */
